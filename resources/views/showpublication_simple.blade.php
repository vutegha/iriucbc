                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        @if($publication->fichier_pdf && pathinfo($publication->fichier_pdf, PATHINFO_EXTENSION) === 'pdf')
                            ...
                            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <button onclick="togglePdfViewer()" 
                                                ...
                                                <span id="viewerToggleText">Afficher le PDF</span>
                                            </button>
                                            <a href="{{ $fileUrl }}" 
                                               target="_blank" 
                                ...
                                <div id="pdfViewerContainer" class="hidden">
                                    <iframe src="{{ $fileUrl }}#toolbar=1&navpanes=1&scrollbar=1&page=1&view=FitH" 
                                            width="100%" 
                                            height="600" 
                                            class="border-0 rounded-b-xl"
                        ...
                        @else
                            <div class="p-12 text-center">
                                <div class="bg-amber-50 border border-amber-200 text-amber-800 p-8 rounded-xl shadow-sm">
                                    <div class="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <i class="fas fa-exclamation-triangle text-2xl text-amber-600"></i>
                                    </div>
                                    <h3 class="text-xl font-semibold mb-3">Aperçu non disponible</h3>
                                    <p class="text-lg mb-6">Ce type de fichier ne peut pas être affiché directement dans le navigateur.</p>
                                    @if($publication->fichier_pdf)
                                        <a href="{{ asset('storage/'.$publication->fichier_pdf) }}" 
                                           target="_blank"
                                           class="inline-flex items-center bg-amber-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-amber-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105">
                                            <i class="fas fa-download mr-2"></i>
...
<script>
    ...
    function togglePdfViewer() {
        ...
        if (isViewerVisible) {
            ...
            toggleText.textContent = 'Afficher le PDF';
            isViewerVisible = false;
        } else {
            container.classList.remove('hidden');
            toggleText.textContent = 'Masquer le PDF';
