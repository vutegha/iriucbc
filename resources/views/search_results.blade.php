    ...
    <section class="relative bg-gradient-to-br from-iri-primary via-iri-secondary to-iri-accent py-20">
        ...
        <div class="absolute top-4 left-4 z-20">
            <nav class="flex space-x-2 text-sm text-white/90" aria-label="Breadcrumb">
                ...
                <span class="text-white font-medium">{{ $currentPage ?? 'Résultats de recherche' }}</span>
            </nav>
        </div>
                                    ...
                                    <div class="h-full flex flex-col">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                                                ...
                                                @if($item->type_global === 'Projet' && property_exists($item, 'service') && $item->service)
                                                    <span class="flex items-center">
                                                ...
                                                @if($item->type_global === 'Projet' && $item->etat)
                                                    <span class="flex items-center">
                                        ...
                                        <div class="flex-1 mb-4">
                                            <p class="text-gray-700 leading-relaxed">
                                                ...
                                                @elseif($item->type_global === 'Projet')
                                                    @if($item->resume)
                                                        {!! extractAndHighlight($item->resume, $query) !!}
                                                    @elseif($item->description)
                                                        {!! extractAndHighlight(Str::limit($item->description, 200), $query) !!}
                                                    @else
