                ...
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="{{ route('site.home') }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('site.publications') }}" class="ml-1 text-sm font-medium text-gray-500 hover:text-gray-700 md:ml-2">Publications</a>
                            </div>
                        </li>
