    ...
    public function run(): void
    {
        ...
        $evenements = [
            [
                ...
                'image' => null,
                'date_debut' => Carbon::now()->addDays(30)->toDateString(),
                'date_fin' => Carbon::now()->addDays(32)->toDateString(),
            ...
            [
                ...
                'image' => null,
                'date_debut' => Carbon::now()->subDays(1)->toDateString(),
                'date_fin' => Carbon::now()->addDays(2)->toDateString(),
            ...
            [
                ...
                'image' => null,
                'date_debut' => Carbon::now()->subDays(38)->toDateString(),
                'date_fin' => Carbon::now()->subDays(36)->toDateString(),
            ...
            [
                ...
                'image' => null,
                'date_debut' => Carbon::now()->subDays(13)->toDateString(),
                'date_fin' => Carbon::now()->subDays(13)->toDateString(),
            ...
            [
                ...
                'image' => null,
                'date_debut' => Carbon::now()->addDays(45)->toDateString(),
                'date_fin' => Carbon::now()->addDays(75)->toDateString(),
